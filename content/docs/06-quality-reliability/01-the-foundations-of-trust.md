...
Some of the most powerful ways to add value are covered in the Storytelling chapter.

This section expands on how the data engineer can add value to quality.
...
Ultimately, data quality or reliability issues are detrimental to users’ trust of the data.

Conversely, quality and reliability are foundations of trust.
